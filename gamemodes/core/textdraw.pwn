...
new Text:PayDayTD_Header,
	Text:PayDayTD_Command;
...
new PlayerText:PayDayTD_String[MAX_PLAYERS];
...
stock PayDayTD_Create_Player(playerid)
{
	PayDayTD_String[playerid] = CreatePlayerTextDraw(playerid, 451.904754, 325.680053, "_~n~__Gauta_alga:_20000$,_mokesciai_valstybei:_200$~n~~n~__Mokesciai_uz_tr._priemones:_200$~n~__Mokesciai_uz_nekilnojamaji_turta:_0$~n~__Mokesciai_uz_verslus:_200$~n~__Nuomos_mokestis:_20$~n~~n~~n~__Gautos_palukanos:_2000$~n~~n~~n~__Buves_banko_balansas:_200$~n~__Dabartinis_banko_balansas:_20000$~n~~n~");
	PlayerTextDrawLetterSize(playerid, PayDayTD_String[playerid], 0.186666, 0.857599);
	PlayerTextDrawTextSize(playerid, PayDayTD_String[playerid], 624.000000, 0.000000);
	PlayerTextDrawAlignment(playerid, PayDayTD_String[playerid], 1);
	PlayerTextDrawColor(playerid, PayDayTD_String[playerid], -1);
	PlayerTextDrawUseBox(playerid, PayDayTD_String[playerid], 1);
	PlayerTextDrawBoxColor(playerid, PayDayTD_String[playerid], 144);
	PlayerTextDrawSetShadow(playerid, PayDayTD_String[playerid], 0);
	PlayerTextDrawSetOutline(playerid, PayDayTD_String[playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, PayDayTD_String[playerid], 0);
	PlayerTextDrawFont(playerid, PayDayTD_String[playerid], 1);
	PlayerTextDrawSetProportional(playerid, PayDayTD_String[playerid], 1);
	PlayerTextDrawSetShadow(playerid, PayDayTD_String[playerid], 0);
}

stock PayDayTD_Create_Global()
{
	PayDayTD_Header = TextDrawCreate(451.904785, 308.613372, "_Los_Santos_Bankas");
	TextDrawLetterSize(PayDayTD_Header, 0.270476, 1.326933);
	TextDrawTextSize(PayDayTD_Header, 624.000000, 0.000000);
	TextDrawAlignment(PayDayTD_Header, 1);
	TextDrawColor(PayDayTD_Header, -10026753);
	TextDrawUseBox(PayDayTD_Header, 1);
	TextDrawBoxColor(PayDayTD_Header, 128);
	TextDrawSetShadow(PayDayTD_Header, 0);
	TextDrawSetOutline(PayDayTD_Header, 0);
	TextDrawBackgroundColor(PayDayTD_Header, -237);
	TextDrawFont(PayDayTD_Header, 1);
	TextDrawSetProportional(PayDayTD_Header, 1);
	TextDrawSetShadow(PayDayTD_Header, 0);

	PayDayTD_Command = TextDrawCreate(542.571899, 313.733276, "/hidepayday");
	TextDrawLetterSize(PayDayTD_Command, 0.103238, 0.678399);
	TextDrawAlignment(PayDayTD_Command, 1);
	TextDrawColor(PayDayTD_Command, -160);
	TextDrawSetShadow(PayDayTD_Command, 0);
	TextDrawSetOutline(PayDayTD_Command, 0);
	TextDrawBackgroundColor(PayDayTD_Command, 255);
	TextDrawFont(PayDayTD_Command, 2);
	TextDrawSetProportional(PayDayTD_Command, 1);
	TextDrawSetShadow(PayDayTD_Command, 0);
	return 1;
}
...
stock TipBox_Create_Global()
{
	...
	TipBox_LowText = TextDrawCreate(137.238128, 323.546600, "SOUTHLAND.LT");
